...
public class DescriptiveStatsBean implements Serializable,Cloneable {
	...
	public DescriptiveStatsBean(){}

	public DescriptiveStatsBean(String columnSelected, double minValue,
